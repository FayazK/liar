    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div>
                <a href="{{ route('home') }}" class="flex items-center gap-3">
                    ...
                    <span class="text-lg font-semibold text-foreground">{{ config('app.name', 'Liar') }}</span>
                </a>
                <p class="mt-4 text-sm text-muted-foreground">
                    A modern, professional Laravel application built with the latest technologies and best practices for rapid development.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3">
                    ...
                    @guest
                        <li>
                            <a href="{{ route('login') }}" class="text-sm text-muted-foreground transition-colors hover:text-foreground">Log in</a>
                        </li>
                    @endguest
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="mt-4 flex gap-4">
                    <a href="#" class="text-muted-foreground transition-colors hover:text-foreground" aria-label="GitHub">
                    ...
                    <a href="#" class="text-muted-foreground transition-colors hover:text-foreground" aria-label="Twitter">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                        </svg>
                    </a>
                    <a href="#" class="text-muted-foreground transition-colors hover:text-foreground" aria-label="LinkedIn">
                        <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="mt-8 border-t border-border pt-8 text-center">
            <p class="text-sm text-muted-foreground">
                &copy; {{ date('Y') }} {{ config('app.name', 'Liar') }}. All rights reserved.
